...
**Used for:** Educational, thought-leadership, or SEO content.
...
## [Section 1: H2]
[2–4 paragraphs. Front-load the key idea. Include 1 concrete
example or quote per section.]

## [Section 2: H2]
[Same pattern. Vary paragraph length.]
...
**Used for:** Single-action pages designed to convert (signups, demos, purchases).

### Structure
```
HEADLINE: [Value prop in 5–8 words: what you do, for whom]
SUBHEAD: [What it's + who it's for + why it's different: 1 sentence]
...
### [Benefit 1 heading]
[One short paragraph that explains the benefit with one concrete detail. don't split this into bullets unless the section is listing specs or steps.]
...
## How it works
[Explain the process in one tight paragraph if it's simple. Use numbered steps only when the reader genuinely needs sequence.]

[Final CTA: verb-named, e.g., "Start free trial"]
```

### Example headline
> "Build docs your team actually reads."
> "Notion for product teams who hate Notion."

### Pitfalls
- Multiple competing CTAs. One page, one action.
- Specs-as-benefits ("256-bit encryption"). Translate to outcomes.
- No objection handling. Address the real fear.

---

## 3. Marketing Email Template

**Used for:** Product announcements, nurturing, re-engagement, newsletters.
...
## 4. Social Post Templates (by platform)
...
↓
[Payoff / punchline / takeaway.]
↓
[Optional: question to drive replies.]
```
**Length:** 1–3 sentences for a single post. For threads, 4–8 tweets max unless the topic demands more.
**Pitfalls:** Hook buried at the end. No takeaway. Threads that pad.
...
### Facebook / Threads
```
[Open question or relatable line.]
...
**Used for:** Validating your product with a real customer story + metrics.

### Structure
```
TITLE: [Outcome in customer's terms, e.g., "How [Customer] cut reporting time 90% with [Product]"]
...
## Why they chose [Product]
[The decision criteria. What alternatives they evaluated.]

## The solution
[What you actually did. Be specific about the implementation,
timeline, and any unexpected turns.]

## The results
[Concrete metrics. Before / after. As many numbers as you have.]
...
**Used for:** B2B lead-gen; establishing deep authority on a strategic topic.
...
## 2. Current approaches and their limits
[What most people do, and why it falls short.]

## 3. The framework (your contribution)
[The original thinking. This is the value-add.]
- [Component 1]
- [Component 2]
- [Component 3]

## 4. How to apply it
[Practical steps. Don't leave it abstract.]

## 5. Case examples
[2–3 short examples. Real names preferred, anonymized acceptable.]

## 6. Risks and limitations
[Acknowledge what the framework doesn't solve. Builds credibility.]
...
## 8. Video Script Template (60–90 sec product/explainer)

**Used for:** Marketing videos, explainers, social ads.
...
### Word count guide
- 60-second script ≈ 150–180 words (read aloud at a natural pace)
- 90-second ≈ 225–270 words
...
**Used for:** Solo episodes or interview prep.
...
[10:00 Section 2: The core topic]
- Question 3:
- Question 4:
...
### Structure
```
TITLE: [Action-oriented, e.g., "Send your first webhook"]

[1-sentence summary of what this doc accomplishes.]

## Prerequisites
- [What you need before starting]
- [Tooling, accounts, prior knowledge]

## Step 1: [Action verb]
[What to do. Show the command or click path. Show expected output.]
```
...
## Next steps
[Link to the next doc or related concept.]
```
...
### Structure
```
## Question 1 (phrased as a human would ask)
[Answer in 1–4 sentences. No walls of text.]
...
### Pitfalls
- Phrasing questions in marketing-speak instead of how users actually ask.
- Long answers when the user wants a fast "yes/no" + context.
- Missing the questions users actually have (use real support tickets / search queries).

---

## 12. Comparison Page Template

**Used for:** Comparison-content that helps a mid-funnel reader decide.
