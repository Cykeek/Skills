...
# Agent reads: .claude/skills/content/content-writer/SKILL.md
```
...
│   ├── template.md
│   └── schema.json
└── .claude-plugin/       # Marketplace plugin (optional)
    └── plugin.json
```
...
```bash
# 1. Plan
cp .claude/skills/templates/SKILL.md skill-spec.md
# Edit skill-spec.md with name, domain, triggers, references

# 2. Scaffold
mkdir -p .claude/skills/<domain>/<skill-name>/{scripts,references,assets}
...
# 4. Validate
python .claude/scripts/validate_skill.py .claude/skills/<domain>/<skill-name>/
```
...
Run all: `python .claude/scripts/validate_all.py`
...
Located in `.claude/scripts/` (to be created):
...
| Old Path | New Path |
|----------|----------|
| `.claude/skills/content-writer/` | `.claude/skills/content/content-writer/` |
| `.claude/skills/cal_booking_skill/` | `.claude/skills/content/cal-com-api/` |
| `.claude/skills/wix_support_skill/` | `.claude/skills/engineering/wix-support/` |
| `.claude/skills/resume-doctor/` | `.claude/skills/productivity/resume-doctor/` |
| `.claude/skills/product-designer/` | `.claude/skills/design/product-designer/` |
| `.claude/skills/resume-doctor/ui-ux-designer/` | `.claude/skills/design/ui-ux-designer/` |
