...
- Remove filler words ("in order to," "due to the fact that").
- Combine adjacent sentences that say nearly the same thing.
- Delete throat-clearing openers ("It is worth noting that…").
...
- **Be specific.** "This is unclear" → "A reader doesn't know what 'leverage' refers to here: name the thing."
