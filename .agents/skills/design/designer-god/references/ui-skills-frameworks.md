# Web Framework UI Patterns and Layout Systems Reference

Practical guidelines for Tailwind CSS, DaisyUI, Shadcn UI setup, Apple SwiftUI workflows, component APIs, structural forms, landing/pricing sections, and visual assets.
...
## Build Primitive (`prototyperai/build-primitive`)

npx skills add https://github.com/PrototyperAI/prototyper-ui --skill build-primitive

---

## Company Logos (`mengto/company-logos`)
...
## Design First UI Prompting (`mengto/design-first-ui-prompting`)

npx skills add https://github.com/MengTo/Skills --skill design-first-ui-prompting

---

## Image To Code (`mengto/image-to-code`)

npx skills add https://github.com/MengTo/Skills --skill image-to-code

---

## Improve UI (`ibelick/improve-ui`)
...
## Pricing Page (`mengto/pricing-page`)

npx skills add https://github.com/MengTo/Skills --skill pricing-page

---

## Redesign Existing Projects (`mengto/redesign-existing-projects`)

npx skills add https://github.com/MengTo/Skills --skill redesign-existing-projects

---

## Redesign Existing Projects (`leonxlnx/redesign-skill`)
...
## Swiftui Pro (`mengto/swiftui-pro`)

npx skills add https://github.com/MengTo/Skills --skill swiftui-pro
