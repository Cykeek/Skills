#!/usr/bin/env python3
"""
Product Designer Skill - Validators
===================================
...
def validate_request(schema_name: str, data: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    schema_map = {
        "design-review-request": "design-review-request",
        "problem-framing-request": "problem-framing-request",
        "research-plan-request": "research-plan-request",
        "design-brief-request": "design-brief-request",
    }
...
def validate_response(schema_name: str, data: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    # Map CLI schema names to file names
    schema_map = {
        "design-review-response": "design-review-response",
        "problem-framing-response": "problem-framing-response",
        "research-plan-response": "research-plan-response",
        "design-brief-response": "design-brief-response",
