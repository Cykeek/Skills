...
from pathlib import Path
	...
	# For shared updates, run scaffold again or copy from .agents/scripts/workspace_utils.py
...
'''
    ...
    print(f"  4. Run validation: python .agents/scripts/validate_skill.py {skill_path}")
